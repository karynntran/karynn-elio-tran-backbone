...
var restaurant = new Project({ name: "Wine & Dine", url: "http://107.170.136.228:1111/", description: "Week 4: Our very first CRUD app: a restaurant app that manages menu items, parties, and orders.", languages: "Ruby, Sinatra and PSQL", photo: "images/projects/wineanddine.png" });

var game = new Project({ name: "Snowman Hangman", url: "http://107.170.136.228:2222/", description: "Week 7: A game app based on hangman that generates random words. Each wrong guess melts the snowman!", languages: "Ruby, Sinatra, SQL, Javascript, AJAX methods", photo: "images/projects/snowman.png" });
